...
import com.mythosil.sss4j.GF256;

/**
 * Default implementation of GF256.
 *
 * <ul>
 * <li>prime: 100011101 <pre>x^8+x^4+x^3+x^2+1</pre></li>
 * <li>generator: 00000010</li>
 * </ul>
 *
 * @since 1.0.0
 */
public class DefaultGF256 implements GF256 {
    ...
    public int add(int x, int y) {
        if (x < 0 || x > 255) {
            ...
            throw new IllegalArgumentException("y should be 0-255");
        }
        return x ^ y;
    }
    ...
    public int mul(int x, int y) {
        ...
        int fieldIndex = (LOG[x] + LOG[y]) % 255;
        return EXP[fieldIndex];
    }
    ...
    public int div(int x, int y) {
        if (y == 0) {
            ...
            throw new IllegalArgumentException("y should be 1-255");
        } else if (x == 0) {
            return 0;
        }
        int fieldIndex = (LOG[x] - LOG[y] + 255) % 255;
        return EXP[fieldIndex];
    }
